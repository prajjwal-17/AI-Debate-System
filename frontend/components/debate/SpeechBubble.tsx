      ...
      {active && text && (
        <motion.div
          ...
          style={{
            ...
            maxWidth: 200, background: "#fff", border: "4px solid #000",
            boxShadow: "4px 4px 0 #000", borderRadius: 10, padding: "10px 14px",
            fontFamily: "'Impact','Arial Black',sans-serif", fontStyle: "italic",
            fontSize: 13, lineHeight: 1.4, color: "#1a0a40",
          }}
        >
